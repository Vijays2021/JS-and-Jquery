...
function validateForm() {
    ...
    var nameErr = emailErr = pwdErr = occupationErr = educationErr = genderErr = true;
    if(name == "") {
    ...
    if(education == "Select") {
        printError("educationErr", "Please select your education");
    } else {
    ...
    if((nameErr || emailErr || pwdErr || occupationErr || educationErr || genderErr) == true) {
       return false;
    } else {
